...
public static class IIPAODKDNIO
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x8079350", Offset = "0x8078750", VA = "0x188079350")]
	public static BGGILCCCKBN NNNJEAIGPIL(this LOMLEAIBBIH LDDMOKMDBGJ)
	{
		return default(BGGILCCCKBN);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum FICFPAPGNDK
{
...
public static class BDLAKCPLDKM
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x80790A0", Offset = "0x80784A0", VA = "0x1880790A0")]
	public static void NBPFEHDJEHH(this GameObject IIKFCCENKCC, FICFPAPGNDK AEPPPPJLFAJ)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x8078E10", Offset = "0x8078210", VA = "0x188078E10")]
	public static void KLHIDAGLOGH(this GameObject IIKFCCENKCC, FICFPAPGNDK KMGGFKGMNNF, FICFPAPGNDK MMJPCGICBLL)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x8079300", Offset = "0x8078700", VA = "0x188079300")]
	public static bool NNIFEBBMNPK(this GameObject IIKFCCENKCC, BGGILCCCKBN PIFGIADBPNJ)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x8079340", Offset = "0x8078740", VA = "0x188079340")]
	public static bool OLLNMJKPDHD(int PEBNJNGMMHE, int KJKJFMDKMPL)
	{
		return default(bool);
	}
	...
	public static bool BDLBGINLCDA(this GameObject IIKFCCENKCC, int KJKJFMDKMPL)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class LDGLNBEBJGF
{
	[Cpp2IlInjected.Token(Token = "0x4000053")]
	public static readonly int GGGNJKMKDBM;

	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int BGOMIFLILIM;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int BHLIDLLBIML;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int IKLKHDFLOFA;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int LKADBIMIJOA;
}
