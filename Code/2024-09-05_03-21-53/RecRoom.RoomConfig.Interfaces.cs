...
public static class PNABMLHCLFN
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, OKJECEMBDMI> DAICAONGDJB;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x722EA40", Offset = "0x722D440", VA = "0x18722EA40")]
	public static bool DCBHEAIHJLO(string MACCBDAFIOO, [Out] OKJECEMBDMI LCPNEJHOLNH)
	{
		return default(bool);
	}
}
