...
public static class NEMMBOEBJGL
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, KOGIADOHFGN> DGNNHLDOMMO;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6F2C560", Offset = "0x6F2AF60", VA = "0x186F2C560")]
	public static bool NMDJKMBCDDJ(string EPCGOOKICEL, [Out] KOGIADOHFGN GPKNPEONEDN)
	{
		return default(bool);
	}
}
