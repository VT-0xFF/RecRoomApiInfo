...
namespace RecRoom.Circuits
{
	...
	public class CircuitNodeGraph : IComparable<CircuitNodeGraph>
	{
		...
		public static CircuitNodeGraphCollectionData PersistAll()
		{
			...
			IEnumerable<CircuitNodeGraphData> enumerable = from g in AllGraphs
				where !g.IsInternalGraph
				select g.Persist();
			circuitNodeGraphCollectionData.Graphs.AddRange(enumerable);
		...
		protected override void _EvaluateNode(bool isMasterClient)
		{
			...
			if (QueuedSignals.Count > 0)
			{
				...
				for (int i = 0; i < array.Length; i++)
				{
					...
					SetMomentaryOutput(outputSlot, outputValue);
				}
			}
		}
...
namespace RecRoom.Circuits.Protobuf
{
	public static class CircuitLinkDataReflection
	{
		...
		static CircuitLinkDataReflection()
		{
			...
			descriptor = FileDescriptor.FromGeneratedCode(Convert.FromBase64String("ChdjaXJjdWl0X2xpbmtfZGF0YS5wcm90bxIIY2lyY3VpdHMiewoPQ2lyY3Vp" + "dExpbmtEYXRhEhYKDnNvdXJjZV9ub2RlX2lkGAEgASgFEhQKDGRlc3Rfbm9k" + "ZV9pZBgCIAEoBRISCgppbnB1dF9zbG90GAMgASgFEhMKC291dHB1dF9zbG90" + "GAQgASgFEhEKCWxpbmtfdHlwZRgFIAEoBUIcqgIZUmVjUm9vbS5DaXJjdWl0" + "cy5Qcm90b2J1ZmIGcHJvdG8z"), (FileDescriptor[])(object)new FileDescriptor[0], new GeneratedClrTypeInfo((Type[])null, (GeneratedClrTypeInfo[])(object)new GeneratedClrTypeInfo[1]
			{
				new GeneratedClrTypeInfo(typeof(CircuitLinkData), (MessageParser)(object)CircuitLinkData.Parser, new string[5] { "SourceNodeId", "DestNodeId", "InputSlot", "OutputSlot", "LinkType" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null)
			}));
		}
	}
	...
	{
		private static readonly MessageParser<CircuitLinkData> _parser = new MessageParser<CircuitLinkData>((Func<CircuitLinkData>)(() => new CircuitLinkData()));
	...
	public static class CircuitNodeDataReflection
	{
		...
		static CircuitNodeDataReflection()
		{
			...
			descriptor = FileDescriptor.FromGeneratedCode(Convert.FromBase64String("ChdjaXJjdWl0X25vZGVfZGF0YS5wcm90bxIIY2lyY3VpdHMaF2NpcmN1aXRf" + "bGlua19kYXRhLnByb3RvGhlub2RlX3RyYW5zZm9ybV9kYXRhLnByb3RvIoQD" + "Cg9DaXJjdWl0Tm9kZURhdGESEQoJbm9kZV9uYW1lGAEgASgJEg8KB25vZGVf" + "aWQYAiABKAUSFgoOcGFpcmVkX25vZGVfaWQYAyABKAUSEQoJbm9kZV90eXBl" + "GAQgASgMEjAKDWNpcmN1aXRfbGlua3MYBiADKAsyGS5jaXJjdWl0cy5DaXJj" + "dWl0TGlua0RhdGESMwoOdHJhbnNmb3JtX2RhdGEYByABKAsyGy5jaXJjdWl0" + "cy5Ob2RlVHJhbnNmb3JtRGF0YRI4ChNpbnRlcm5hbF9ncmFwaF9kYXRhGAgg" + "ASgLMhsuY2lyY3VpdHMuSW50ZXJuYWxHcmFwaERhdGESJAoIc2xvdERhdGEY" + "CSADKAsyEi5jaXJjdWl0cy5TbG90RGF0YRIMCgRtb2RlGAogASgFEjYKEnNl" + "bGVjdG9yX25vZGVfZGF0YRgLIAEoCzIaLmNpcmN1aXRzLlNlbGVjdG9yTm9k" + "ZURhdGESFQoNYWR2YW5jZWRfbW9kZRgMIAEoCCJhChBTZWxlY3Rvck5vZGVE" + "YXRhEhEKCWV2YWxfbW9kZRgBIAEoBRI6ChRzZWxlY3Rvcl9jb25maWdfZGF0" + "YRgCIAMoCzIcLmNpcmN1aXRzLlNlbGVjdG9yQ29uZmlnRGF0YSJ/ChFJbnRl" + "cm5hbEdyYXBoRGF0YRIVCg1pbnB1dF9ub2RlX2lkGAEgASgFEhYKDm91dHB1" + "dF9ub2RlX2lkGAIgASgFEjsKE2ludGVybmFsX25vZGVfZ3JhcGgYAyABKAsy" + "Hi5jaXJjdWl0cy5DaXJjdWl0Tm9kZUdyYXBoRGF0YSKvAQoUQ2lyY3VpdE5v" + "ZGVHcmFwaERhdGESFwoPbm9kZV9ncmFwaF9ndWlkGAEgASgMEhkKEWlzX2lu" + "dGVybmFsX2dyYXBoGAIgASgIEjEKDnJvb3Rfbm9kZV9kYXRhGAMgASgLMhku" + "Y2lyY3VpdHMuQ2lyY3VpdE5vZGVEYXRhEjAKDWNpcmN1aXRfbm9kZXMYBCAD" + "KAsyGS5jaXJjdWl0cy5DaXJjdWl0Tm9kZURhdGEiUAoeQ2lyY3VpdE5vZGVH" + "cmFwaENvbGxlY3Rpb25EYXRhEi4KBmdyYXBocxgBIAMoCzIeLmNpcmN1aXRz" + "LkNpcmN1aXROb2RlR3JhcGhEYXRhIigKCFNsb3REYXRhEgwKBHNsb3QYASAB" + "KAUSDgoGc2lnbmFsGAIgASgFIkEKElNlbGVjdG9yQ29uZmlnRGF0YRIUCgxj" + "b21wYXJlX21vZGUYASABKAUSFQoNY29tcGFyZV92YWx1ZRgCIAEoBUIcqgIZ" + "UmVjUm9vbS5DaXJjdWl0cy5Qcm90b2J1ZmIGcHJvdG8z"), (FileDescriptor[])(object)new FileDescriptor[2]
			{
				CircuitLinkDataReflection.Descriptor,
				NodeTransformDataReflection.Descriptor
			}, new GeneratedClrTypeInfo((Type[])null, (GeneratedClrTypeInfo[])(object)new GeneratedClrTypeInfo[7]
			{
				new GeneratedClrTypeInfo(typeof(CircuitNodeData), (MessageParser)(object)CircuitNodeData.Parser, new string[11]
				{
				...
				new GeneratedClrTypeInfo(typeof(SelectorNodeData), (MessageParser)(object)SelectorNodeData.Parser, new string[2] { "EvalMode", "SelectorConfigData" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null),
				new GeneratedClrTypeInfo(typeof(InternalGraphData), (MessageParser)(object)InternalGraphData.Parser, new string[3] { "InputNodeId", "OutputNodeId", "InternalNodeGraph" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null),
				new GeneratedClrTypeInfo(typeof(CircuitNodeGraphData), (MessageParser)(object)CircuitNodeGraphData.Parser, new string[4] { "NodeGraphGuid", "IsInternalGraph", "RootNodeData", "CircuitNodes" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null),
				new GeneratedClrTypeInfo(typeof(CircuitNodeGraphCollectionData), (MessageParser)(object)CircuitNodeGraphCollectionData.Parser, new string[1] { "Graphs" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null),
				new GeneratedClrTypeInfo(typeof(SlotData), (MessageParser)(object)SlotData.Parser, new string[2] { "Slot", "Signal" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null),
				new GeneratedClrTypeInfo(typeof(SelectorConfigData), (MessageParser)(object)SelectorConfigData.Parser, new string[2] { "CompareMode", "CompareValue" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null)
			}));
		}
	}
	...
	{
		private static readonly MessageParser<CircuitNodeData> _parser = new MessageParser<CircuitNodeData>((Func<CircuitNodeData>)(() => new CircuitNodeData()));
		...
		private static readonly FieldCodec<CircuitLinkData> _repeated_circuitLinks_codec = FieldCodec.ForMessage<CircuitLinkData>(50u, CircuitLinkData.Parser);
		...
		private static readonly FieldCodec<SlotData> _repeated_slotData_codec = FieldCodec.ForMessage<SlotData>(74u, RecRoom.Circuits.Protobuf.SlotData.Parser);
		...
		public string NodeName
		{
			...
			set
			{
				nodeName_ = ProtoPreconditions.CheckNotNull<string>(value, "value");
			}
		}
		...
		public ByteString NodeType
		{
			...
			set
			{
				nodeType_ = ProtoPreconditions.CheckNotNull<ByteString>(value, "value");
			}
		}
		...
		public override int GetHashCode()
		{
			...
			{
				num ^= ((object)NodeType).GetHashCode();
			}
			num ^= ((object)circuitLinks_).GetHashCode();
			...
			num ^= ((object)slotData_).GetHashCode();
			if (Mode != 0)
			{
		...
		public void WriteTo(CodedOutputStream output)
		{
			...
			if (transformData_ != null)
			{
				...
				output.WriteMessage((IMessage)(object)TransformData);
			}
			if (internalGraphData_ != null)
			{
				output.WriteRawTag((byte)66);
				output.WriteMessage((IMessage)(object)InternalGraphData);
			}
			...
			if (selectorNodeData_ != null)
			{
				...
				output.WriteMessage((IMessage)(object)SelectorNodeData);
			}
			if (AdvancedMode)
			{
		...
		public int CalculateSize()
		{
			...
			if (transformData_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)TransformData);
			}
			if (internalGraphData_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)InternalGraphData);
			}
			...
			if (selectorNodeData_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)SelectorNodeData);
			}
			if (AdvancedMode)
			{
				num += 2;
		...
		public void MergeFrom(CircuitNodeData other)
		{
			...
			circuitLinks_.Add((IEnumerable<CircuitLinkData>)other.circuitLinks_);
			...
			slotData_.Add((IEnumerable<SlotData>)other.slotData_);
			if (other.Mode != 0)
			{
				Mode = other.Mode;
			}
		...
		public void MergeFrom(CodedInputStream input)
		{
			...
			while ((num = input.ReadTag()) != 0)
			{
				...
				case 58u:
					...
					input.ReadMessage((IMessage)(object)transformData_);
					break;
				case 66u:
					if (internalGraphData_ == null)
					{
					...
					input.ReadMessage((IMessage)(object)internalGraphData_);
					break;
				case 74u:
				...
				case 90u:
					...
					input.ReadMessage((IMessage)(object)selectorNodeData_);
					break;
				case 96u:
	...
	{
		private static readonly MessageParser<SelectorNodeData> _parser = new MessageParser<SelectorNodeData>((Func<SelectorNodeData>)(() => new SelectorNodeData()));
		...
		private static readonly FieldCodec<SelectorConfigData> _repeated_selectorConfigData_codec = FieldCodec.ForMessage<SelectorConfigData>(18u, RecRoom.Circuits.Protobuf.SelectorConfigData.Parser);
		...
		public override int GetHashCode()
		{
			...
			return num ^ ((object)selectorConfigData_).GetHashCode();
		}
		...
		public void MergeFrom(SelectorNodeData other)
		{
			if (other != null)
			{
				...
				selectorConfigData_.Add((IEnumerable<SelectorConfigData>)other.selectorConfigData_);
			}
		}
	...
	{
		private static readonly MessageParser<InternalGraphData> _parser = new MessageParser<InternalGraphData>((Func<InternalGraphData>)(() => new InternalGraphData()));
		...
		public void WriteTo(CodedOutputStream output)
		{
			...
			if (internalNodeGraph_ != null)
			{
				...
				output.WriteMessage((IMessage)(object)InternalNodeGraph);
			}
		}
		...
		public int CalculateSize()
		{
			...
			if (internalNodeGraph_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)InternalNodeGraph);
			}
			return num;
		}
		...
		public void MergeFrom(CodedInputStream input)
		{
			...
			while ((num = input.ReadTag()) != 0)
			{
				...
				case 26u:
					...
					input.ReadMessage((IMessage)(object)internalNodeGraph_);
					break;
				}
			}
		}
	...
	{
		private static readonly MessageParser<CircuitNodeGraphData> _parser = new MessageParser<CircuitNodeGraphData>((Func<CircuitNodeGraphData>)(() => new CircuitNodeGraphData()));
		...
		private static readonly FieldCodec<CircuitNodeData> _repeated_circuitNodes_codec = FieldCodec.ForMessage<CircuitNodeData>(34u, CircuitNodeData.Parser);
		...
		public ByteString NodeGraphGuid
		{
			...
			set
			{
				nodeGraphGuid_ = ProtoPreconditions.CheckNotNull<ByteString>(value, "value");
			}
		}
		...
		public override int GetHashCode()
		{
			...
			{
				num ^= ((object)NodeGraphGuid).GetHashCode();
			}
			if (IsInternalGraph)
			{
			...
			return num ^ ((object)circuitNodes_).GetHashCode();
		}
		...
		public void WriteTo(CodedOutputStream output)
		{
			...
			{
				output.WriteRawTag((byte)26);
				output.WriteMessage((IMessage)(object)RootNodeData);
			}
		...
		public int CalculateSize()
		{
			...
			if (rootNodeData_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)RootNodeData);
			}
		...
		public void MergeFrom(CircuitNodeGraphData other)
		{
			...
			circuitNodes_.Add((IEnumerable<CircuitNodeData>)other.circuitNodes_);
		}
		...
		public void MergeFrom(CodedInputStream input)
		{
			...
			while ((num = input.ReadTag()) != 0)
			{
				...
				case 26u:
					...
					input.ReadMessage((IMessage)(object)rootNodeData_);
					break;
				case 34u:
	...
	{
		private static readonly MessageParser<CircuitNodeGraphCollectionData> _parser = new MessageParser<CircuitNodeGraphCollectionData>((Func<CircuitNodeGraphCollectionData>)(() => new CircuitNodeGraphCollectionData()));

		public const int GraphsFieldNumber = 1;

		private static readonly FieldCodec<CircuitNodeGraphData> _repeated_graphs_codec = FieldCodec.ForMessage<CircuitNodeGraphData>(10u, CircuitNodeGraphData.Parser);
		...
		public override int GetHashCode()
		{
			return 1 ^ ((object)graphs_).GetHashCode();
		}
		...
		public void MergeFrom(CircuitNodeGraphCollectionData other)
		{
			if (other != null)
			{
				graphs_.Add((IEnumerable<CircuitNodeGraphData>)other.graphs_);
			}
		}
	...
	{
		private static readonly MessageParser<SlotData> _parser = new MessageParser<SlotData>((Func<SlotData>)(() => new SlotData()));
	...
	{
		private static readonly MessageParser<SelectorConfigData> _parser = new MessageParser<SelectorConfigData>((Func<SelectorConfigData>)(() => new SelectorConfigData()));
	...
	public static class NodeTransformDataReflection
	{
		...
		static NodeTransformDataReflection()
		{
			...
			descriptor = FileDescriptor.FromGeneratedCode(Convert.FromBase64String("Chlub2RlX3RyYW5zZm9ybV9kYXRhLnByb3RvEghjaXJjdWl0cxoSdmVjdG9y" + "M19kYXRhLnByb3RvImUKEU5vZGVUcmFuc2Zvcm1EYXRhEicKCHBvc2l0aW9u" + "GAEgASgLMhUuY2lyY3VpdHMuVmVjdG9yM0RhdGESJwoIcm90YXRpb24YAiAB" + "KAsyFS5jaXJjdWl0cy5WZWN0b3IzRGF0YUIcqgIZUmVjUm9vbS5DaXJjdWl0" + "cy5Qcm90b2J1ZmIGcHJvdG8z"), (FileDescriptor[])(object)new FileDescriptor[1] { Vector3DataReflection.Descriptor }, new GeneratedClrTypeInfo((Type[])null, (GeneratedClrTypeInfo[])(object)new GeneratedClrTypeInfo[1]
			{
				new GeneratedClrTypeInfo(typeof(NodeTransformData), (MessageParser)(object)NodeTransformData.Parser, new string[2] { "Position", "Rotation" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null)
			}));
		}
	}
	...
	{
		private static readonly MessageParser<NodeTransformData> _parser = new MessageParser<NodeTransformData>((Func<NodeTransformData>)(() => new NodeTransformData()));
		...
		public void WriteTo(CodedOutputStream output)
		{
			...
			{
				output.WriteRawTag((byte)10);
				output.WriteMessage((IMessage)(object)Position);
			}
			if (rotation_ != null)
			{
				output.WriteRawTag((byte)18);
				output.WriteMessage((IMessage)(object)Rotation);
			}
		}
		...
		public int CalculateSize()
		{
			...
			if (position_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)Position);
			}
			if (rotation_ != null)
			{
				num += 1 + CodedOutputStream.ComputeMessageSize((IMessage)(object)Rotation);
			}
			return num;
		}
		...
		public void MergeFrom(CodedInputStream input)
		{
			...
			while ((num = input.ReadTag()) != 0)
			{
				...
				case 10u:
					...
					input.ReadMessage((IMessage)(object)position_);
					break;
				case 18u:
					if (rotation_ == null)
					{
					...
					input.ReadMessage((IMessage)(object)rotation_);
					break;
				}
			}
		}
	...
	public static class Vector3DataReflection
	{
		...
		static Vector3DataReflection()
		{
			...
			descriptor = FileDescriptor.FromGeneratedCode(Convert.FromBase64String("ChJ2ZWN0b3IzX2RhdGEucHJvdG8SCGNpcmN1aXRzIi4KC1ZlY3RvcjNEYXRh" + "EgkKAXgYASABKAISCQoBeRgCIAEoAhIJCgF6GAMgASgCQhyqAhlSZWNSb29t" + "LkNpcmN1aXRzLlByb3RvYnVmYgZwcm90bzM="), (FileDescriptor[])(object)new FileDescriptor[0], new GeneratedClrTypeInfo((Type[])null, (GeneratedClrTypeInfo[])(object)new GeneratedClrTypeInfo[1]
			{
				new GeneratedClrTypeInfo(typeof(Vector3Data), (MessageParser)(object)Vector3Data.Parser, new string[3] { "X", "Y", "Z" }, (string[])null, (Type[])null, (GeneratedClrTypeInfo[])null)
			}));
		}
	}
	public sealed class Vector3Data : IMessage<Vector3Data>, IMessage, IEquatable<Vector3Data>, IDeepCloneable<Vector3Data>
	{
		private static readonly MessageParser<Vector3Data> _parser = new MessageParser<Vector3Data>((Func<Vector3Data>)(() => new Vector3Data()));
