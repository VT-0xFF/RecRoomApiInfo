...
public static class LGMOGDECLMG
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x7334510", Offset = "0x7333110", VA = "0x187334510")]
	public static DLDENPKLDMK GEIHPFKJJPJ(this LDKCFFAAMAJ CNDJAPHANLG)
	{
		return default(DLDENPKLDMK);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum ODEJNCJNCBO
{
...
public static class GNFEMBHFBFA
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x7333E80", Offset = "0x7332A80", VA = "0x187333E80")]
	public static void CDNCLGIKHKN(this GameObject OJCNPGOLEHK, ODEJNCJNCBO IJAMBPIAAJO)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x73341E0", Offset = "0x7332DE0", VA = "0x1873341E0")]
	public static void KOMCEDOECFM(this GameObject OJCNPGOLEHK, ODEJNCJNCBO ENFIMLBKGFP, ODEJNCJNCBO PKANOINNDBA)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x73341A0", Offset = "0x7332DA0", VA = "0x1873341A0")]
	public static bool GEIGFNHFIJG(this GameObject OJCNPGOLEHK, DLDENPKLDMK PDLMAKCGIAP)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x7334470", Offset = "0x7333070", VA = "0x187334470")]
	public static bool OICGIGIABFH(int IIPLJLPCLBC, int KFEKOLALCDK)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x73340E0", Offset = "0x7332CE0", VA = "0x1873340E0")]
	public static bool FFIBBJPHJOA(this GameObject OJCNPGOLEHK, int KFEKOLALCDK)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class GPNILECNMJD
{
	[Cpp2IlInjected.Token(Token = "0x4000053")]
	public static readonly int HMJLKCCBFBL;

	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int PAKPKICINOD;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int IMBFENOMJOM;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int HNBIJFNMMOA;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int OAKNPMLPCGA;
}
