...
public static class HGBKDKOMDHE
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, NDFGJLDMKHN> JJKKHNLNFAO;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6662B10", Offset = "0x6661910", VA = "0x186662B10")]
	public static bool EMHKBCLCPNM(string OJGDBKKBFCI, [Out] NDFGJLDMKHN PHJFGJAKPGK)
	{
		return default(bool);
	}
}
