...
public static class IAAPMDFGFOI
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, JHEFNOBKLPO> EGBDOKEEGGF;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6661BB0", Offset = "0x6660FB0", VA = "0x186661BB0")]
	public static bool NICDJPMLKAP(string ECJHPOBJIOM, [Out] JHEFNOBKLPO EPOJLLJMEHO)
	{
		return default(bool);
	}
}
