...
namespace RecRoom.ProgressionEvents
{
	...
	public interface BNEIJCOKLRA
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO KFAUARNHUTY
		{
		...
		ProgressionEventRecordDTO EVDSOUIOGRJ
		{
		...
		ProgressionEventStatus XUHRROLTECU
		{
		...
		event Action EMKVJHLCQMH;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action ZABVYJIBOYJ;

		[Cpp2IlInjected.Token(Token = "0x600000D")]
		[Cpp2IlInjected.Address(Slot = "12")]
		NDLOPTUCVYP<bool> PJCTQZJVSDR();

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		VCIEUBMMHTW Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		VCIEUBMMHTW DEWSYWGTWSR(int a);
		...
		UncollectedRewardsData VESGMOVHNCK();
