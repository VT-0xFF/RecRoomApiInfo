...
public static class GBPIKAHJNOF
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x8ADB8B0", Offset = "0x8ADA0B0", VA = "0x188ADB8B0")]
	public static BJMNHFKNCIB PHAJCIIJLNG(this BOEAGPNCNDN FHNAKMKCKGN)
	{
		return default(BJMNHFKNCIB);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum EEJNACPNKOG
{
...
public static class OPGNIKMMNBL
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x8ADBCB0", Offset = "0x8ADA4B0", VA = "0x188ADBCB0")]
	public static void MCDABJHNFHF(this GameObject EMOLHEPHCGI, EEJNACPNKOG GBIENHEIENE)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x8ADB920", Offset = "0x8ADA120", VA = "0x188ADB920")]
	public static void DKDLNLCDKAF(this GameObject EMOLHEPHCGI, EEJNACPNKOG PKMCKBHLOHO, EEJNACPNKOG HPDEKBHKABH)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x8ADBC70", Offset = "0x8ADA470", VA = "0x188ADBC70")]
	public static bool JNJNJMHGBLB(this GameObject EMOLHEPHCGI, BJMNHFKNCIB AONMOGLBEIB)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x8ADBF10", Offset = "0x8ADA710", VA = "0x188ADBF10")]
	public static bool MKNAKIDLHGL(int MGONBEDEDON, int CGLFEDOLDAB)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x8ADBBB0", Offset = "0x8ADA3B0", VA = "0x188ADBBB0")]
	public static bool FJIGKEOMFNJ(this GameObject EMOLHEPHCGI, int CGLFEDOLDAB)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class DMJGJHEHHAL
{
	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int AKPEMDGMJLH;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int HJPOKDDDAIG;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int CELCBFHBFHF;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int FHFIPNGOLKD;

	[Cpp2IlInjected.Token(Token = "0x4000058")]
	public static readonly int JAJPGDMMPJG;

	[Cpp2IlInjected.Token(Token = "0x4000059")]
	public static readonly int FGGODMNHLLJ;
}
