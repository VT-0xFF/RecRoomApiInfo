...
public struct ILBJKOKJFAE
{
	...
	[Cpp2IlInjected.Address(RVA = "0x6FFA560", Offset = "0x6FF9160", VA = "0x186FFA560")]
...
public interface DBLEGAFLABD
{
	...
	NBFPPJGKGOH<Guid> DLECKKNFDNC(LNCLLEGDNJK PIKCKAKDFFC);
	...
	NBFPPJGKGOH<int> LKLGDPDJJBP(long HAMIEGOKEJC, long JEBGGHOLKHJ, [Optional] LNCLLEGDNJK? PIKCKAKDFFC);

	[Cpp2IlInjected.Token(Token = "0x6000019")]
	[Cpp2IlInjected.Address(Slot = "23")]
	NBFPPJGKGOH<int> ODKKCKLKDMP(long HAMIEGOKEJC, long JEBGGHOLKHJ, [Optional] LNCLLEGDNJK? PIKCKAKDFFC);

	[Cpp2IlInjected.Token(Token = "0x600001A")]
	[Cpp2IlInjected.Address(Slot = "24")]
	NBFPPJGKGOH<Dictionary<LNCLLEGDNJK, int>> NFPPPLBCDGB(long HAMIEGOKEJC, long JEBGGHOLKHJ);

	[Cpp2IlInjected.Token(Token = "0x600001B")]
	[Cpp2IlInjected.Address(Slot = "25")]
	NBFPPJGKGOH<Dictionary<LNCLLEGDNJK, int>> GICMJGFPMKE(long HAMIEGOKEJC, long JEBGGHOLKHJ);

	[Cpp2IlInjected.Token(Token = "0x600001C")]
	[Cpp2IlInjected.Address(Slot = "26")]
	NBFPPJGKGOH<IEnumerable<Guid>> NHMNMGCCMAL(long HAMIEGOKEJC, long JEBGGHOLKHJ, [Optional] LNCLLEGDNJK? PIKCKAKDFFC);

	[Cpp2IlInjected.Token(Token = "0x600001D")]
	[Cpp2IlInjected.Address(Slot = "27")]
	NBFPPJGKGOH<IEnumerable<Guid>> AFJEGDJGBGL(long HAMIEGOKEJC, long JEBGGHOLKHJ, [Optional] LNCLLEGDNJK? PIKCKAKDFFC);
