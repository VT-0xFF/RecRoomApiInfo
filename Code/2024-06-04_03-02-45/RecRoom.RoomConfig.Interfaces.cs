...
public static class GHOGADANGFI
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, PMCPOOCLOAB> CADMODNDKNH;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6EA4B10", Offset = "0x6EA3310", VA = "0x186EA4B10")]
	public static bool GFIHGBPIMCF(string NKGLNCLKMCB, [Out] PMCPOOCLOAB LBANIEJNOIP)
	{
		return default(bool);
	}
}
