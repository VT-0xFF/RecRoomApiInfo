...
public static class FKAENLHFDJD
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, ABKBLDBOPKP> PMFOPFKPOHG;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6F3F4F0", Offset = "0x6F3DEF0", VA = "0x186F3F4F0")]
	public static bool AKPHPFIGELN(string MPJKJPAAADJ, [Out] ABKBLDBOPKP OODHBEDJENO)
	{
		return default(bool);
	}
}
