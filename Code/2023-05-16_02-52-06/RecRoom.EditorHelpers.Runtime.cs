...
namespace RecRoom.EditorUtils
{
	...
	public abstract class EditorPrefabReference<T> : EditorPrefabReference where T : Component
	{
		...
		public T Prefab
		{
			...
			[Cpp2IlInjected.Address(RVA = "0x1058C40", Offset = "0x1057A40", VA = "0x181058C40")]
			get
			{
				return null;
			}
			[Cpp2IlInjected.Token(Token = "0x6000003")]
			[Cpp2IlInjected.Address(RVA = "0x1058C60", Offset = "0x1057A60", VA = "0x181058C60")]
			set
			{
			}
		}
		...
		private static T MLDEKCBFDJD(ref T NJHAFFLAKOG, ref string HEFDCDAGGFF)
		{
			return null;
		}
		...
		private static string JBOMCAFDMLD(T NJHAFFLAKOG)
		{
			return null;
		}
