...
namespace RecRoom.ProgressionEvents
{
	...
	public interface DUNZSOMMSPV
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO QQGDPBXWJSL
		{
		...
		ProgressionEventRecordDTO KQQQMJVDWIC
		{
		...
		ProgressionEventStatus YSCMJPZNKQV
		{
		...
		event Action YMUZTCBSMZG;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action RKHHUGHYZMG;

		[Cpp2IlInjected.Token(Token = "0x600000C")]
		[Cpp2IlInjected.Address(Slot = "11")]
		YLZUVDOLRNC<bool> EMQHGUKCDGA();

		[Cpp2IlInjected.Token(Token = "0x600000D")]
		[Cpp2IlInjected.Address(Slot = "12")]
		WGVXBSAEBCD Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		WGVXBSAEBCD MEEPQUIRLWE(int a);
		...
		UncollectedRewardsData ARQEITAHSQH();
	}
