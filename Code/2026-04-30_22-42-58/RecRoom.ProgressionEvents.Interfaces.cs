...
namespace RecRoom.ProgressionEvents
{
	...
	public interface LCFERMQTTJC
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO WQVBIYUJWPC
		{
		...
		ProgressionEventRecordDTO NQGQUFLTALX
		{
		...
		ProgressionEventStatus ORJQAMXLEVQ
		{
		...
		event Action DZATTALEYZL;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action LZEXBFMJOFV;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		FCGSBMYYMMV<bool> UVGMXSUQYVX();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		NKOSDRYVRPY Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		NKOSDRYVRPY XLAKPGLCKJN(int a);
		...
		UncollectedRewardsData IBZJZUPBOVW();
