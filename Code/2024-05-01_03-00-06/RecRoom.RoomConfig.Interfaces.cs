...
public static class CHCMCBFBKCP
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, COOBEHIAGKA> FKNEOPJHLFO;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x67FECF0", Offset = "0x67FDAF0", VA = "0x1867FECF0")]
	public static bool JJGGEGPCFME(string PAAEHAEBJCN, [Out] COOBEHIAGKA LIAKDIHFADF)
	{
		return default(bool);
	}
}
