...
namespace RecRoom.ProgressionEvents
{
	...
	public interface BJPQGXAIUXB
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO MLZLCMVITXF
		{
		...
		ProgressionEventRecordDTO DDITWRFSFWO
		{
		...
		ProgressionEventStatus FHERVPDBZIV
		{
		...
		event Action NBEOPEAFCIM;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action YKGZSOIUMZM;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		PVOPFDWRLHK<bool> ZDOADGGWWEM();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		DNXWICJZUNF Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		DNXWICJZUNF CCENWFZHIJW(int a);
		...
		UncollectedRewardsData ZPWCIHFYBFN();
