...
public static class FGAOIGMJKPN
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, OCONMGGEDCG> LNCBEIOHNJP;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6547AC0", Offset = "0x65464C0", VA = "0x186547AC0")]
	public static bool MFCFPLHBNLD(string KKCEDJAAKPM, [Out] OCONMGGEDCG OIEGPBDOILH)
	{
		return default(bool);
	}
}
