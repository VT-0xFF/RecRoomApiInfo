...
public static class OGGAJEACCON
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x8377AD0", Offset = "0x8376ED0", VA = "0x188377AD0")]
	public static KNEFELIAOHD OEPKFMABKHI(this CIOGCNBPCHB OFPEACEHPHM)
	{
		return default(KNEFELIAOHD);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum BBALLFNENKK
{
...
public static class CFCMLMGLBPP
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x83774D0", Offset = "0x83768D0", VA = "0x1883774D0")]
	public static void EGAMFALNCMD(this GameObject GIIGFIAPGGB, BBALLFNENKK DMGLPHIJGLL)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x83777F0", Offset = "0x8376BF0", VA = "0x1883777F0")]
	public static void IEGMADGMIHG(this GameObject GIIGFIAPGGB, BBALLFNENKK HLBJGPKMDEN, BBALLFNENKK NBNKCEHMMFD)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x8377A80", Offset = "0x8376E80", VA = "0x188377A80")]
	public static bool JMKIOFIJNIC(this GameObject GIIGFIAPGGB, KNEFELIAOHD PEBFFMPGHOK)
	{
		return default(bool);
	}
	...
	public static bool LDKEOKGANBE(int FFOEEMKIKJO, int MIPBHMAKNFM)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x8377730", Offset = "0x8376B30", VA = "0x188377730")]
	public static bool GIDMNKGEJIN(this GameObject GIIGFIAPGGB, int MIPBHMAKNFM)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class BIBICPAFBGI
{
	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int IOMFMNGGKJD;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int MGDJLBBMICM;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int MNHIGAPEIPG;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int GLCGCFGLMLJ;

	[Cpp2IlInjected.Token(Token = "0x4000058")]
	public static readonly int KIMLKNLKGAD;
}
