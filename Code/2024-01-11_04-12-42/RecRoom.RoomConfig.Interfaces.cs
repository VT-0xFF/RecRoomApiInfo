...
public static class BJIMIFAFBAC
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, NJCPFJAMKIP> MHIPJCHHHFL;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x659EFE0", Offset = "0x659D9E0", VA = "0x18659EFE0")]
	public static bool GFGJHMKHGPD(string OLJEDFAEDEP, [Out] NJCPFJAMKIP DKFFFJFJNNK)
	{
		return default(bool);
	}
}
