...
public static class LNKKLLDKDEL
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x7C405D0", Offset = "0x7C3F7D0", VA = "0x187C405D0")]
	public static OACBODAHBBH BHLLHJEEPFC(this JGILHIHCHLF NNAHMHFEOCF)
	{
		return default(OACBODAHBBH);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum EKGOHKDJGOB
{
...
public static class IDGEFGKDFLB
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x7C40370", Offset = "0x7C3F570", VA = "0x187C40370")]
	public static void PEDNLGGHILP(this GameObject GBMEGJCINPI, EKGOHKDJGOB DDNEALBALGE)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x7C400E0", Offset = "0x7C3F2E0", VA = "0x187C400E0")]
	public static void MDGEDJAKKJH(this GameObject GBMEGJCINPI, EKGOHKDJGOB FNKCHEEIGOI, EKGOHKDJGOB OJDCDBBKGFI)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x7C3FFD0", Offset = "0x7C3F1D0", VA = "0x187C3FFD0")]
	public static bool GECMACNHPNA(this GameObject GBMEGJCINPI, OACBODAHBBH HCHLOOPEHAF)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x7C40010", Offset = "0x7C3F210", VA = "0x187C40010")]
	public static bool GGCAIJBFCLO(int OMEFCJCOLII, int MJIBNAFOCFM)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x7C40020", Offset = "0x7C3F220", VA = "0x187C40020")]
	public static bool LCMPNNAMDPN(this GameObject GBMEGJCINPI, int MJIBNAFOCFM)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class NAKKLMEFNGO
{
	[Cpp2IlInjected.Token(Token = "0x4000053")]
	public static readonly int NEMFLLLGGDB;

	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int DCBAMBKHBON;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int MHCBFDCLDBL;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int EKNNGHMDGAA;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int HMLHMGKMADE;
}
