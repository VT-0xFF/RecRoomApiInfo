...
namespace RecRoom.ProgressionEvents
{
	...
	public interface FUFVWINYFFS
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO VAZWWMVAXHO
		{
		...
		ProgressionEventRecordDTO BTCTNYWMNLD
		{
		...
		ProgressionEventStatus RZDNMGNBFQG
		{
		...
		event Action HGUBOJEKYEF;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action FKIPTAZYPHN;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		DLXOODTYWKJ<bool> QVJSVOWJREN();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		UXDBKRJQXAW Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		UXDBKRJQXAW UNPZPFTDFFZ(int a);
		...
		UncollectedRewardsData YFJVLHZVWGE();
