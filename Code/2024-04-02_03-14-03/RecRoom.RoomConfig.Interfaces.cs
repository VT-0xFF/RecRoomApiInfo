...
public static class GHLMNLKNNFB
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, PMDBJMDCIPH> DJHFHICEBLF;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x66EAE70", Offset = "0x66E9A70", VA = "0x1866EAE70")]
	public static bool PODAMIMAFNE(string GHMAFBFMFGA, [Out] PMDBJMDCIPH HPGOCBNKMCB)
	{
		return default(bool);
	}
}
