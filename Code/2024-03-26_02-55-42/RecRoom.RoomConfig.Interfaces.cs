...
public static class IIJBGIJNGKM
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, EMDGFIJEIOH> CHJMELONEJI;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x677B700", Offset = "0x677AB00", VA = "0x18677B700")]
	public static bool JFDMGELHHBG(string IPHOCNLOBFO, [Out] EMDGFIJEIOH CHDKCFAGHGM)
	{
		return default(bool);
	}
}
