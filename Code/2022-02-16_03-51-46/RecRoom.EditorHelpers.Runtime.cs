...
namespace RecRoom.EditorUtils
{
	...
	public abstract class EditorPrefabReference<T> : EditorPrefabReference where T : Component
	{
		...
		public T Prefab
		{
			...
			[Cpp2IlInjected.Address(RVA = "0x33ADB70", Offset = "0x33AC370", VA = "0x1833ADB70")]
			get
			{
				return null;
			}
			[Cpp2IlInjected.Token(Token = "0x6000003")]
			[Cpp2IlInjected.Address(RVA = "0x33ADB90", Offset = "0x33AC390", VA = "0x1833ADB90")]
			set
			{
			}
		}
		...
		private static T HNLLHDEIMAF(ref T OHDEILNFJIP, ref string INBEMGIPAPA)
		{
			return null;
		}
		...
		private static string GCMFLICGFEL(T OHDEILNFJIP)
		{
			return null;
		}
