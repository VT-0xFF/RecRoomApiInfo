...
public static class HGGKCFANKCF
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, OOFIHHKJHCF> CCKGFODOOPJ;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x71EAD20", Offset = "0x71E9320", VA = "0x1871EAD20")]
	public static bool LAFFHOKCOBI(string HDNFENGLHEK, [Out] OOFIHHKJHCF DBFNEOCMANL)
	{
		return default(bool);
	}
}
