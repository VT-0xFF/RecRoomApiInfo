...
public static class NKOBLNJEDOE
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, PPEPOINMEHK> NOPJBFPIEPP;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x65A0CD0", Offset = "0x659FAD0", VA = "0x1865A0CD0")]
	public static bool JPCECNBPLDE(string EAPCCGDEOOA, [Out] PPEPOINMEHK DPANFEOIIMA)
	{
		return default(bool);
	}
}
