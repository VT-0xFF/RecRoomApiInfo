...
namespace RecRoom.EditorUtils
{
	...
	public abstract class EditorPrefabReference<T> : EditorPrefabReference where T : Component
	{
		...
		public T Prefab
		{
			...
			[Cpp2IlInjected.Address(RVA = "0x895C40", Offset = "0x894E40", VA = "0x180895C40")]
			get
			{
				return null;
			}
			[Cpp2IlInjected.Token(Token = "0x6000003")]
			[Cpp2IlInjected.Address(RVA = "0x895C60", Offset = "0x894E60", VA = "0x180895C60")]
			set
			{
			}
		}
		...
		private static T MDPEOFOIHOD(ref T FDPMGBKAFIM, ref string POFKNBBNDJA)
		{
			return null;
		}
		...
		private static string PKNCANGMPMM(T FDPMGBKAFIM)
		{
			return null;
		}
