...
namespace RecRoom.ProgressionEvents
{
	...
	public interface RCSWNUGOUJA
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO PZNGWSBVGLE
		{
		...
		ProgressionEventRecordDTO BDLLGNLUXCX
		{
		...
		ProgressionEventStatus NXSPYGHMTIQ
		{
		...
		event Action DPAHAEGHYZZ;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action JFRKISDMGUN;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		MPVTAJGPRUT<bool> TGUZCFBEYTF();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		NXPIPFBMDQY Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		NXPIPFBMDQY EXWYSAVTEEJ(int a);
		...
		UncollectedRewardsData ARNJWQEHTMK();
