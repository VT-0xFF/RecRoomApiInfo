...
public static class JDPHEPNHKAN
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, IAGELFGALDI> FGBPKGFBPOO;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x68A2EC0", Offset = "0x68A1EC0", VA = "0x1868A2EC0")]
	public static bool DKPMPOAPJNG(string OCEONIIHJNI, [Out] IAGELFGALDI EDLCCHGJONF)
	{
		return default(bool);
	}
}
