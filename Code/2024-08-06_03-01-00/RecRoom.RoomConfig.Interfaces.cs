...
public static class HIIBDLCJPMO
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, CMPIECDJDIC> MNFHMFLKABL;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x700BA00", Offset = "0x700A000", VA = "0x18700BA00")]
	public static bool NCAHNJJKPNF(string GBHMMBBHNKG, [Out] CMPIECDJDIC GOMBEALOMON)
	{
		return default(bool);
	}
}
