...
public static class ABCOLBILINC
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, ANMFDCMMPJG> NCMKKEMBBPB;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x63BE130", Offset = "0x63BC930", VA = "0x1863BE130")]
	public static bool POGGOEPLKIB(string KNPNJBLHNJN, [Out] ANMFDCMMPJG DDBCLAHLAOB)
	{
		return default(bool);
	}
}
