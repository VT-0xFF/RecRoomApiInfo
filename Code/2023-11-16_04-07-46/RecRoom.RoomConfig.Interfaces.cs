...
public static class LJNKBIKJKCH
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, IJLDJNNJNOK> APEDGPJMOEF;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x639ED40", Offset = "0x639DD40", VA = "0x18639ED40")]
	public static bool KMJKDBDGJFH(string PEAJDFHINDK, [Out] IJLDJNNJNOK ICBEPPBBIKE)
	{
		return default(bool);
	}
}
