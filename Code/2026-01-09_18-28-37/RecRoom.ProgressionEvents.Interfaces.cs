...
namespace RecRoom.ProgressionEvents
{
	...
	public interface MWDJOFCSZRG
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO HYHIQBPDUAU
		{
		...
		ProgressionEventRecordDTO ZGKJTBIDCMR
		{
		...
		ProgressionEventStatus VRZJWWNTNDM
		{
		...
		event Action WHKPHYJLPUV;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action QJHQDRKSGLF;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		KOPZSJWAQQR<bool> QQKQFZICCRL();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		SKSLBBUJUBM Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		SKSLBBUJUBM JSJBWAFLPJV(int a);
		...
		UncollectedRewardsData YNLDIVBRAFK();
