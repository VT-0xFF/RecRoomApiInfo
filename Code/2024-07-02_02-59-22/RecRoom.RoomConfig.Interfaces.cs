...
public static class OOFCOKDIGFO
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, HLJDICKLHEP> ICHHGJNDNMB;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6FD08A0", Offset = "0x6FCF8A0", VA = "0x186FD08A0")]
	public static bool MMCLNKMOKEF(string KEAIJJPGFIF, [Out] HLJDICKLHEP NAMPKJNECEB)
	{
		return default(bool);
	}
}
