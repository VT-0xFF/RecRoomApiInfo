...
public static class MALJJGOGPFC
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, GNNKGNDMFOI> OHAGHIOCPMC;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x63981C0", Offset = "0x6396FC0", VA = "0x1863981C0")]
	public static bool OLBECDHEMJL(string NLLHECCFKDH, [Out] GNNKGNDMFOI FJLECDLOIGK)
	{
		return default(bool);
	}
}
