...
public static class NPKENGJIKKG
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, JHDBMKJLNEM> AHCHILIJDKJ;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x65DE680", Offset = "0x65DDA80", VA = "0x1865DE680")]
	public static bool KDHJGKFFEEJ(string PGOOJAJALME, [Out] JHDBMKJLNEM IIGLBKKMIEK)
	{
		return default(bool);
	}
}
