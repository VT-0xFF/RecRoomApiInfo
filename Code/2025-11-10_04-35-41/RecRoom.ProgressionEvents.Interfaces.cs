...
namespace RecRoom.ProgressionEvents
{
	...
	public interface EKBUNAQULDO
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO HIVUHXAWDSQ
		{
		...
		ProgressionEventRecordDTO KYWRIJCVNNX
		{
		...
		ProgressionEventStatus ARKCPMFWUQS
		{
		...
		event Action WILSXEBXMFT;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action SAJPOEZWPQD;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		SPVBYBYHFON<bool> WCKKZGUFGVP();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		BRWPWCYORRE Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		BRWPWCYORRE BCMDYXLNSRN(int a);
		...
		string NVOWNXHAXKY(ProgressionEventConfigurableTextType a);

		[Cpp2IlInjected.Token(Token = "0x6000014")]
		[Cpp2IlInjected.Address(Slot = "19")]
		UncollectedRewardsData ZERDRIPAWMA();
