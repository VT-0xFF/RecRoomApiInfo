...
public static class BKNOMENBBBM
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, MMCKDFJKIGA> CKIBOPCNHLC;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x721A810", Offset = "0x7219210", VA = "0x18721A810")]
	public static bool FJHIBPMOMDE(string ALLNMNPMHJB, [Out] MMCKDFJKIGA MHCPAPBOMNJ)
	{
		return default(bool);
	}
}
