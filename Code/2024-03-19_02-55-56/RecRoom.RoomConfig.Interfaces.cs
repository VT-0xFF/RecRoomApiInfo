...
public static class BOJLAGONAPD
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, KKBFOFAMKMI> LFHJIDNOKKN;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x674BB90", Offset = "0x674AB90", VA = "0x18674BB90")]
	public static bool IJFOADKACJF(string GLHMOFACANC, [Out] KKBFOFAMKMI OCDONGOMPGP)
	{
		return default(bool);
	}
}
