...
public static class PKJBOJKNNPG
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, EONIMKIFDHN> ODGIDCLPBOF;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6FEB900", Offset = "0x6FEA900", VA = "0x186FEB900")]
	public static bool HNEILIJEPGH(string LJABFNCLPBJ, [Out] EONIMKIFDHN HKCMDFBNFFA)
	{
		return default(bool);
	}
}
