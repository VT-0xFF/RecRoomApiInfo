...
public static class EONFIGFLCHN
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, LAMHEAMBFBP> IJDAHONEGDM;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x692D580", Offset = "0x692BF80", VA = "0x18692D580")]
	public static bool PJCFHHABBNE(string FKPJFBEJDMG, [Out] LAMHEAMBFBP DJLPCNHKKCB)
	{
		return default(bool);
	}
}
