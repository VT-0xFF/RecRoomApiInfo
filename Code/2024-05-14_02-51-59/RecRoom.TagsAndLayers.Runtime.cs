...
public static class DEHPMIDKHLG
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6C240C0", Offset = "0x6C22AC0", VA = "0x186C240C0")]
	public static DCADOANLNDF GPGJJMMNMLJ(this BLHPIHCIOAI CKAGANMNMLM)
	{
		return default(DCADOANLNDF);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum NAPAIIIFNCE
{
...
public static class GDMGGNEPJFN
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x6C244E0", Offset = "0x6C22EE0", VA = "0x186C244E0")]
	public static void LOBJENIJJGK(this GameObject PACDKKMGCFJ, NAPAIIIFNCE MLNMEAKGKNK)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x6C24240", Offset = "0x6C22C40", VA = "0x186C24240")]
	public static void KLCFGMOFOPI(this GameObject PACDKKMGCFJ, NAPAIIIFNCE LNJPEAKCCII, NAPAIIIFNCE DHJBFNCMGEH)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x6C24200", Offset = "0x6C22C00", VA = "0x186C24200")]
	public static bool IKHPNCHEFNJ(this GameObject PACDKKMGCFJ, DCADOANLNDF EGHLEBJNHDM)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x6C241F0", Offset = "0x6C22BF0", VA = "0x186C241F0")]
	public static bool FHLOKONKIND(int AEJBOLFACJC, int OMAIMPMIEEG)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x6C24130", Offset = "0x6C22B30", VA = "0x186C24130")]
	public static bool CIMMIEOGANN(this GameObject PACDKKMGCFJ, int OMAIMPMIEEG)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class MIDFACIJMPP
{
	[Cpp2IlInjected.Token(Token = "0x4000053")]
	public static readonly int CHPIFNKFEGH;

	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int JMPJEAEACLN;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int EKAHPJKLMOG;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int FFAJDNCFEIO;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int INLFMMMMMMM;
}
