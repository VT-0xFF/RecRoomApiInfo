...
namespace RecRoom.EditorUtils
{
	...
	public abstract class EditorPrefabReference<T> : EditorPrefabReference where T : Component
	{
		...
		public T Prefab
		{
			...
			[Cpp2IlInjected.Address(RVA = "0x225B740", Offset = "0x225A140", VA = "0x18225B740")]
			get
			{
				return null;
			}
			[Cpp2IlInjected.Token(Token = "0x6000003")]
			[Cpp2IlInjected.Address(RVA = "0x225B760", Offset = "0x225A160", VA = "0x18225B760")]
			set
			{
			}
		}
		...
		private static T COIHJJFIIGJ(ref T LCJJJOBEFIC, ref string PAOPGDCPHFF)
		{
			return null;
		}
		...
		private static string IDBPDELAKAO(T LCJJJOBEFIC)
		{
			return null;
		}
