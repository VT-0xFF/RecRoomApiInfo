...
public static class KFLFGIMNMBK
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, BDDEIHLNPOI> LNAIBFJIFKN;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x763F060", Offset = "0x763D860", VA = "0x18763F060")]
	public static bool HDDNHEKKGGH(string LGFCGKGBBAB, [Out] BDDEIHLNPOI AELPFAFKICJ)
	{
		return default(bool);
	}
}
