...
public static class JMHEDKOANEH
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x760E6A0", Offset = "0x760D8A0", VA = "0x18760E6A0")]
	public static KDAIOGKCFGJ AJJLGIMFIHE(this EAAOEEPGNOE LCBNAMPIGON)
	{
		return default(KDAIOGKCFGJ);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum FGAIJAEJBCB
{
...
public static class EHGOFMKOMEE
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x760E440", Offset = "0x760D640", VA = "0x18760E440")]
	public static void OFMGMCOKANE(this GameObject PLNJOBKLAEE, FGAIJAEJBCB FKKDMNGBFLM)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x760E160", Offset = "0x760D360", VA = "0x18760E160")]
	public static void ENFHEPGDJOH(this GameObject PLNJOBKLAEE, FGAIJAEJBCB CIFCEHHJGPH, FGAIJAEJBCB JFIBLNJBLHC)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x760E400", Offset = "0x760D600", VA = "0x18760E400")]
	public static bool JLFCCAJGNFI(this GameObject PLNJOBKLAEE, KDAIOGKCFGJ GKHJHBBOFBL)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x760E3F0", Offset = "0x760D5F0", VA = "0x18760E3F0")]
	public static bool HNKNLLENHNH(int JECHHBGMFLN, int FHNAJNDLFPG)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x760E0A0", Offset = "0x760D2A0", VA = "0x18760E0A0")]
	public static bool BOGPOEBFJLB(this GameObject PLNJOBKLAEE, int FHNAJNDLFPG)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class OGEGMJAGOGE
{
	[Cpp2IlInjected.Token(Token = "0x4000053")]
	public static readonly int BIIEEBIEDPP;

	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int DLKLLONJNFJ;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int JELKMAKPGGP;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int GHAFIKAGAOD;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int BDCEFPGNLAL;
}
