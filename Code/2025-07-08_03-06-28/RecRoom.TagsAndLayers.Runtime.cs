...
public static class BPNNAMKGPHM
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x8C29670", Offset = "0x8C28470", VA = "0x188C29670")]
	public static IJPAJBMGPGN DIOIOPOHEPF(this CLFGBFPPDAJ FGHIFDOONDE)
	{
		return default(IJPAJBMGPGN);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum LICBNCEOIEB
{
...
public static class BHMFPDDBNKO
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x8C29080", Offset = "0x8C27E80", VA = "0x188C29080")]
	public static void GLBFEMPLEDD(this GameObject JLNNGPHDMLM, LICBNCEOIEB FEMFINBCNMC)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x8C293A0", Offset = "0x8C281A0", VA = "0x188C293A0")]
	public static void NIOKFGMJPKH(this GameObject JLNNGPHDMLM, LICBNCEOIEB IFJBMDELGHC, LICBNCEOIEB LFKBOAMKBEA)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x8C29630", Offset = "0x8C28430", VA = "0x188C29630")]
	public static bool ODKFBMLHFGA(this GameObject JLNNGPHDMLM, IJPAJBMGPGN DOOJLAHCGHB)
	{
		return default(bool);
	}
	...
	public static bool BHNJONNFMBN(int BNECONOIKOE, int OJPMOAFECJO)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x8C292E0", Offset = "0x8C280E0", VA = "0x188C292E0")]
	public static bool HJMGOMBHHFI(this GameObject JLNNGPHDMLM, int OJPMOAFECJO)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class DFJONEOJCOC
{
	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int INPMALJMHFG;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int IHBANFNHLJO;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int IGGFOKMADIO;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int OMJOKPMMLPO;

	[Cpp2IlInjected.Token(Token = "0x4000058")]
	public static readonly int PCMPGDNKDMN;

	[Cpp2IlInjected.Token(Token = "0x4000059")]
	public static readonly int GDOAEFDKKBB;
}
