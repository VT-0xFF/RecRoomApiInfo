...
public static class CFLGLIMGNJD
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, GIJAPFNLFMP> FEMKPDFDMKO;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x7071DA0", Offset = "0x70703A0", VA = "0x187071DA0")]
	public static bool APLEJEFPFAB(string FFCDPLCEOKG, [Out] GIJAPFNLFMP LNAOIGBMCFE)
	{
		return default(bool);
	}
}
