...
public interface KNJOEGIPOFK
{
	[Cpp2IlInjected.Token(Token = "0x17000001")]
	ProgressionEventDTO GBAKEDIOCCF
	{
	...
	ProgressionEventRecordDTO NCMIFBEHDMM
	{
	...
	event Action AGPMCMKPJAK;

	[Cpp2IlInjected.Token(Token = "0x14000002")]
	event Action GPLPNJKDICA;

	[Cpp2IlInjected.Token(Token = "0x6000009")]
	[Cpp2IlInjected.Address(Slot = "8")]
	MNHDJBCOCND<bool> KJIGLFICBNJ();

	[Cpp2IlInjected.Token(Token = "0x600000A")]
	[Cpp2IlInjected.Address(Slot = "9")]
	LDHIGNIGDAL FFLBJMNJKKA(bool GBAFKOKNMLL = false);

	[Cpp2IlInjected.Token(Token = "0x600000B")]
	[Cpp2IlInjected.Address(Slot = "10")]
	LDHIGNIGDAL EINDBPMCLBL(int OIMNPEKJKAH);
