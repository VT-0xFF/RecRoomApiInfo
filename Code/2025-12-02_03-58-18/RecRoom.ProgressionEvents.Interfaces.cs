...
namespace RecRoom.ProgressionEvents
{
	...
	public interface CIPZQPHUGED
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO UIIAPDFAORR
		{
		...
		ProgressionEventRecordDTO KBUNSSEQDTI
		{
		...
		ProgressionEventStatus BUYKUPDYCSZ
		{
		...
		event Action MGAHTZUDOJW;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action JWQIJJZNHKK;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		PYAXBIZPKFO<bool> AZQBIFFCHXW();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		MRIYACRIYFZ Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		MRIYACRIYFZ DNRVTMMBQBC(int a);
		...
		UncollectedRewardsData UUVGJLQOEXB();
