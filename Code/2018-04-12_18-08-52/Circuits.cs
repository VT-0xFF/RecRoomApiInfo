...
namespace RecRoom.Circuits.Protobuf
{
	...
	public static class CircuitNodeDataReflection
	{
		...
		{
			descriptor = FileDescriptor.FromGeneratedCode(Convert.FromBase64String("ChdjaXJjdWl0X25vZGVfZGF0YS5wcm90bxIIY2lyY3VpdHMaF2NpcmN1aXRf" + "bGlua19kYXRhLnByb3RvGhlub2RlX3RyYW5zZm9ybV9kYXRhLnByb3RvIu0C" + "Cg9DaXJjdWl0Tm9kZURhdGESEQoJbm9kZV9uYW1lGAEgASgJEg8KB25vZGVf" + "aWQYAiABKAUSFgoOcGFpcmVkX25vZGVfaWQYAyABKAUSEQoJbm9kZV90eXBl" + "GAQgASgMEjAKDWNpcmN1aXRfbGlua3MYBiADKAsyGS5jaXJjdWl0cy5DaXJj" + "dWl0TGlua0RhdGESMwoOdHJhbnNmb3JtX2RhdGEYByABKAsyGy5jaXJjdWl0" + "cy5Ob2RlVHJhbnNmb3JtRGF0YRI4ChNpbnRlcm5hbF9ncmFwaF9kYXRhGAgg" + "ASgLMhsuY2lyY3VpdHMuSW50ZXJuYWxHcmFwaERhdGESJAoIc2xvdERhdGEY" + "CSADKAsyEi5jaXJjdWl0cy5TbG90RGF0YRIMCgRtb2RlGAogASgFEjYKEnNl" + "bGVjdG9yX25vZGVfZGF0YRgLIAEoCzIaLmNpcmN1aXRzLlNlbGVjdG9yTm9k" + "ZURhdGEiYQoQU2VsZWN0b3JOb2RlRGF0YRIRCglldmFsX21vZGUYASABKAUS" + "OgoUc2VsZWN0b3JfY29uZmlnX2RhdGEYAiADKAsyHC5jaXJjdWl0cy5TZWxl" + "Y3RvckNvbmZpZ0RhdGEifwoRSW50ZXJuYWxHcmFwaERhdGESFQoNaW5wdXRf" + "bm9kZV9pZBgBIAEoBRIWCg5vdXRwdXRfbm9kZV9pZBgCIAEoBRI7ChNpbnRl" + "cm5hbF9ub2RlX2dyYXBoGAMgASgLMh4uY2lyY3VpdHMuQ2lyY3VpdE5vZGVH" + "cmFwaERhdGEirwEKFENpcmN1aXROb2RlR3JhcGhEYXRhEhcKD25vZGVfZ3Jh" + "cGhfZ3VpZBgBIAEoDBIZChFpc19pbnRlcm5hbF9ncmFwaBgCIAEoCBIxCg5y" + "b290X25vZGVfZGF0YRgDIAEoCzIZLmNpcmN1aXRzLkNpcmN1aXROb2RlRGF0" + "YRIwCg1jaXJjdWl0X25vZGVzGAQgAygLMhkuY2lyY3VpdHMuQ2lyY3VpdE5v" + "ZGVEYXRhIlAKHkNpcmN1aXROb2RlR3JhcGhDb2xsZWN0aW9uRGF0YRIuCgZn" + "cmFwaHMYASADKAsyHi5jaXJjdWl0cy5DaXJjdWl0Tm9kZUdyYXBoRGF0YSIo" + "CghTbG90RGF0YRIMCgRzbG90GAEgASgFEg4KBnNpZ25hbBgCIAEoBSJBChJT" + "ZWxlY3RvckNvbmZpZ0RhdGESFAoMY29tcGFyZV9tb2RlGAEgASgFEhUKDWNv" + "bXBhcmVfdmFsdWUYAiABKAVCHKoCGVJlY1Jvb20uQ2lyY3VpdHMuUHJvdG9i" + "dWZiBnByb3RvMw=="), new FileDescriptor[2]
			{
			...
			{
				new GeneratedClrTypeInfo(typeof(CircuitNodeData), CircuitNodeData.Parser, new string[10] { "NodeName", "NodeId", "PairedNodeId", "NodeType", "CircuitLinks", "TransformData", "InternalGraphData", "SlotData", "Mode", "SelectorNodeData" }, null, null, null),
