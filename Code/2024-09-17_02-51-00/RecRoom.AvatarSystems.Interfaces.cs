...
namespace System.Runtime.CompilerServices
{
	...
	internal sealed class NullableAttribute : Attribute
	{
		...
		[Cpp2IlInjected.Address(RVA = "0x6B06B60", Offset = "0x6B05560", VA = "0x186B06B60")]
...
public interface DGFMLABLMOB
{
	...
	void DDMEIOHLIBC(bool GECBJHMPCNC);
...
public interface AJNIAJIHFAO
{
	...
	[Cpp2IlInjected.Address(Slot = "13")]
	List<FBMKHJEBFJF> OJAABACEOCB(AvatarItemBodyType JNPGJADOLAG, bool IPMFJLFEKJP = false);

	[Cpp2IlInjected.Token(Token = "0x600005A")]
	[Cpp2IlInjected.Address(Slot = "14")]
	List<FBMKHJEBFJF> BKOFLLJNCED(AvatarItemBodyType JNPGJADOLAG);
...
public interface PDJHHOACBKG
{
	...
	[Cpp2IlInjected.Address(Slot = "9")]
	float IKBKNMGNHOC(FaceFeatureType KDLEIJBEDLO, float EDJLNIKJGIK, MMBBNHOOGFA KLAGAOLBONF);
}
