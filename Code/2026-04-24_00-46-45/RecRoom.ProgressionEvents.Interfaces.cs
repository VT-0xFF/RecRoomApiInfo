...
namespace RecRoom.ProgressionEvents
{
	...
	public interface IVQGEWMQWUY
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO ETRQPYORCUY
		{
		...
		ProgressionEventRecordDTO GZDGBRLDUWB
		{
		...
		ProgressionEventStatus IMNDHKYTHRE
		{
		...
		event Action CSPZQTETYBL;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action HNPDMCWZSOT;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		AUAMWGBNBSF<bool> VCNYDLUOOON();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		LTBUWQFXCGW Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		LTBUWQFXCGW KWKDPBBRPOX(int a);
		...
		UncollectedRewardsData BIAAZGZUMGU();
