...
public static class IPDGHNPMMKE
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x8F0D7B0", Offset = "0x8F0C5B0", VA = "0x188F0D7B0")]
	public static HCNNJNFGAOH MAOCLMOEHNF(this HPLEOAILJJI BNNFDCBCIEK)
	{
		return default(HCNNJNFGAOH);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum HGNPGFJCOLF
{
...
public static class KEOFCJDGKHL
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x8F0DBC0", Offset = "0x8F0C9C0", VA = "0x188F0DBC0")]
	public static void IPFAOHBCOMC(this GameObject DFFAMKHOIDB, HGNPGFJCOLF OGEICBNAJLO)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x8F0D8E0", Offset = "0x8F0C6E0", VA = "0x188F0D8E0")]
	public static void CJEMDEGOABI(this GameObject DFFAMKHOIDB, HGNPGFJCOLF IDBLAAEBMML, HGNPGFJCOLF FJAFMJACKOL)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x8F0DB80", Offset = "0x8F0C980", VA = "0x188F0DB80")]
	public static bool HOJNPMKIGON(this GameObject DFFAMKHOIDB, HCNNJNFGAOH BLBCFJMGFEL)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x8F0DE20", Offset = "0x8F0CC20", VA = "0x188F0DE20")]
	public static bool PKPCEEPEFAO(int HGMAIPELJHM, int FGNIIONMKMI)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x8F0D820", Offset = "0x8F0C620", VA = "0x188F0D820")]
	public static bool BLCLFBMOJJH(this GameObject DFFAMKHOIDB, int FGNIIONMKMI)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class GHDBGEDJLIB
{
	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int KFGFFPKFMEJ;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int FLIKCJBOBCE;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int JOGHPLMFJBG;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int IIECIFOGOJJ;

	[Cpp2IlInjected.Token(Token = "0x4000058")]
	public static readonly int NCGKGLLECCP;

	[Cpp2IlInjected.Token(Token = "0x4000059")]
	public static readonly int JBIBANOBCMJ;
}
