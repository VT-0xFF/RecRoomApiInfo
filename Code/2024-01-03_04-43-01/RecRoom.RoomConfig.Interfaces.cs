...
public static class PDMNNFOBEFM
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, JNGBMKLMEBJ> LINFICAJOOJ;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x63BFCD0", Offset = "0x63BE8D0", VA = "0x1863BFCD0")]
	public static bool IKGDLKABABA(string IAJDMFOEJBI, [Out] JNGBMKLMEBJ KDCJKAGAHDO)
	{
		return default(bool);
	}
}
