...
namespace RecRoom.ProgressionEvents
{
	...
	public interface FXJCVIXFMJM
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO QZYBXEKJAUW
		{
		...
		ProgressionEventRecordDTO VQPSYWHXSJJ
		{
		...
		ProgressionEventStatus MWBHCZPWRYU
		{
		...
		event Action NWDBXFPEXHV;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action ABYIYEFJTMV;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		IMNXFPWKHPJ<bool> SBLAUTBEPPV();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		GMTKWIVSBCA Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		GMTKWIVSBCA KNKMFYEGDYB(int a);
		...
		UncollectedRewardsData QEMDGGXULYW();
