...
public static class JHIEHJFKPOL
{
	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x90014E0", Offset = "0x8FFFAE0", VA = "0x1890014E0")]
	public static JOEINDELGAM HOONLGHBEBL(this AAONAKBAHLD FMPIJFLMMMN)
	{
		return default(JOEINDELGAM);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000005")]
public enum JMELGOAGEHE
{
...
public static class IJHFOJFGAMJ
{
	[Cpp2IlInjected.Token(Token = "0x6000002")]
	[Cpp2IlInjected.Address(RVA = "0x9001170", Offset = "0x8FFF770", VA = "0x189001170")]
	public static void GPINOOHDGIB(this GameObject EGMHLHLEIMH, JMELGOAGEHE CGCOAIEEKKE)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000003")]
	[Cpp2IlInjected.Address(RVA = "0x9000EE0", Offset = "0x8FFF4E0", VA = "0x189000EE0")]
	public static void DKOICBHHIOI(this GameObject EGMHLHLEIMH, JMELGOAGEHE PJBFGNPMAEF, JMELGOAGEHE EBGPHNCKPJG)
	{
	}

	[Cpp2IlInjected.Token(Token = "0x6000004")]
	[Cpp2IlInjected.Address(RVA = "0x90014A0", Offset = "0x8FFFAA0", VA = "0x1890014A0")]
	public static bool ODBCCNGOKDO(this GameObject EGMHLHLEIMH, JOEINDELGAM CCEKBFDLNBD)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000005")]
	[Cpp2IlInjected.Address(RVA = "0x9001490", Offset = "0x8FFFA90", VA = "0x189001490")]
	public static bool KOHOPNBPFGB(int FKMNCAKIOFK, int CNBAIILCHLD)
	{
		return default(bool);
	}

	[Cpp2IlInjected.Token(Token = "0x6000006")]
	[Cpp2IlInjected.Address(RVA = "0x90013D0", Offset = "0x8FFF9D0", VA = "0x1890013D0")]
	public static bool HKOGJFGCHGH(this GameObject EGMHLHLEIMH, int CNBAIILCHLD)
	{
		return default(bool);
	}
}
[Cpp2IlInjected.Token(Token = "0x2000007")]
public static class KKDENPJGGMB
{
	[Cpp2IlInjected.Token(Token = "0x4000054")]
	public static readonly int BBFDGACIANB;

	[Cpp2IlInjected.Token(Token = "0x4000055")]
	public static readonly int IFNKEBMABDH;

	[Cpp2IlInjected.Token(Token = "0x4000056")]
	public static readonly int OKGHLPKMDPB;

	[Cpp2IlInjected.Token(Token = "0x4000057")]
	public static readonly int GBBPLEFLJNI;

	[Cpp2IlInjected.Token(Token = "0x4000058")]
	public static readonly int CHDPHBDKIJO;

	[Cpp2IlInjected.Token(Token = "0x4000059")]
	public static readonly int NDNNKHJHDPN;
}
