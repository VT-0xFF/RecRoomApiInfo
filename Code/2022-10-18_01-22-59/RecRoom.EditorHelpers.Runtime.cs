...
namespace RecRoom.EditorUtils
{
	...
	public abstract class EditorPrefabReference<T> : EditorPrefabReference where T : Component
	{
		...
		public T Prefab
		{
			...
			[Cpp2IlInjected.Address(RVA = "0x1CBC0D0", Offset = "0x1CBB0D0", VA = "0x181CBC0D0")]
			get
			{
				return null;
			}
			[Cpp2IlInjected.Token(Token = "0x6000003")]
			[Cpp2IlInjected.Address(RVA = "0x1CBC0F0", Offset = "0x1CBB0F0", VA = "0x181CBC0F0")]
			set
			{
			}
		}
		...
		private static T IOLGMDLDDIN(ref T JNHEKGFBNMC, ref string BAIKAJBBENC)
		{
			return null;
		}
		...
		private static string INNAHODHBDJ(T JNHEKGFBNMC)
		{
			return null;
		}
