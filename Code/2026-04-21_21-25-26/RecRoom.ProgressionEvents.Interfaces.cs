...
namespace RecRoom.ProgressionEvents
{
	...
	public interface CZQWKYEIRQV
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO KQAPOUUKCGV
		{
		...
		ProgressionEventRecordDTO QABJTFCZSUA
		{
		...
		ProgressionEventStatus BPDCVTKFSZR
		{
		...
		event Action OGIYCDGNLAW;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action GSHVILVJNYI;

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		CCAFLELIKTY<bool> GUZFTWHTIYO();

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		NFPDGBDVXFD Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x6000010")]
		[Cpp2IlInjected.Address(Slot = "15")]
		NFPDGBDVXFD IUHQVVQLFBU(int a);
		...
		UncollectedRewardsData MIHTDOQVYBP();
