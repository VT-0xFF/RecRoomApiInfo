...
public static class HDJNFELPKKD
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, MEKMLPEGLFG> PCCFHPOLNHD;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x73FB750", Offset = "0x73FAB50", VA = "0x1873FB750")]
	public static bool NKKJANMEMGN(string MLKNKIIMLAJ, [Out] MEKMLPEGLFG EAFHKBHPEIB)
	{
		return default(bool);
	}
}
