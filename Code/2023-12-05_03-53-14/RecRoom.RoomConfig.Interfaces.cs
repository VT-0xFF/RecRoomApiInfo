...
public static class HNCGIFLEABO
{
	[Cpp2IlInjected.Token(Token = "0x400002B")]
	private static readonly Dictionary<string, EEADOGOFNCB> CHEAGDGHJHO;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x63BF4E0", Offset = "0x63BE8E0", VA = "0x1863BF4E0")]
	public static bool AFCHMNEGHNL(string DFKPAPHDIHE, [Out] EEADOGOFNCB IKHOJOLHDEK)
	{
		return default(bool);
	}
}
