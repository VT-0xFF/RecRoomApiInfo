...
namespace RecRoom.ProgressionEvents
{
	...
	public interface LSZOLXDIHEX
	{
		[Cpp2IlInjected.Token(Token = "0x17000001")]
		ProgressionEventDTO CKBQIXCNYDV
		{
		...
		ProgressionEventRecordDTO EJSLLUPJURI
		{
		...
		ProgressionEventStatus LXBLVQDMWND
		{
		...
		event Action HEHAJBGWNCA;

		[Cpp2IlInjected.Token(Token = "0x14000002")]
		event Action VYADRMRPUIC;

		[Cpp2IlInjected.Token(Token = "0x600000D")]
		[Cpp2IlInjected.Address(Slot = "12")]
		WCGMKCSPRXW<bool> EBIXZXOWPCA();

		[Cpp2IlInjected.Token(Token = "0x600000E")]
		[Cpp2IlInjected.Address(Slot = "13")]
		DQILUIFDCOX Refresh(bool forceUpdateCache = false);

		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "14")]
		DQILUIFDCOX BTPEZUAYZAI(int a);
		...
		string DELMZXVNVXV(ProgressionEventConfigurableTextType a);

		[Cpp2IlInjected.Token(Token = "0x6000013")]
		[Cpp2IlInjected.Address(Slot = "18")]
		UncollectedRewardsData LVJGZLRRZFR();
