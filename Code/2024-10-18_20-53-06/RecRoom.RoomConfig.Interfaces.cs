...
public static class OMNPDMIKEDM
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, GCLCFNGPMNH> NJOAGDFDJCM;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x7474BD0", Offset = "0x7473FD0", VA = "0x187474BD0")]
	public static bool LCKMIEGKAOE(string ADEDLKKPFKG, [Out] GCLCFNGPMNH MHDOPFNMJEE)
	{
		return default(bool);
	}
}
