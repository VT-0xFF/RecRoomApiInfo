...
public interface KGGIDKBMOPH
{
	[Cpp2IlInjected.Token(Token = "0x17000001")]
	ProgressionEventDTO NFAEBMHKPKF
	{
	...
	ProgressionEventRecordDTO KPFPHGFIIMO
	{
	...
	event Action NAICBIMEMME;

	[Cpp2IlInjected.Token(Token = "0x14000002")]
	event Action KKBBKPGKAHN;

	[Cpp2IlInjected.Token(Token = "0x600000A")]
	[Cpp2IlInjected.Address(Slot = "9")]
	MPBOGDMHBIL<bool> EAFNFNJBLOI();

	[Cpp2IlInjected.Token(Token = "0x600000B")]
	[Cpp2IlInjected.Address(Slot = "10")]
	FDBBAHKKNBB MKPJAGMNGLJ(bool NKCBPFIECJC = false);

	[Cpp2IlInjected.Token(Token = "0x600000C")]
	[Cpp2IlInjected.Address(Slot = "11")]
	FDBBAHKKNBB HJDKFLBGMNI(int IAPBNMJDHCD);
	...
	(int, List<int>, int, List<int>, int, List<int>) LPMOKAJHHNG();
}
[Cpp2IlInjected.Token(Token = "0x2000004")]
public enum KAAHDAPEMLH
{
