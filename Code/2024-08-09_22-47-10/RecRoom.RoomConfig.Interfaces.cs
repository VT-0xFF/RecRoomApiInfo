...
public static class MIBKNEIAJAB
{
	[Cpp2IlInjected.Token(Token = "0x400002C")]
	private static readonly Dictionary<string, LKFNNDNNMGG> PACJFCCGOPC;

	[Cpp2IlInjected.Token(Token = "0x6000001")]
	[Cpp2IlInjected.Address(RVA = "0x6F5CED0", Offset = "0x6F5C2D0", VA = "0x186F5CED0")]
	public static bool LPPDNPILAFJ(string PEPENGANDGG, [Out] LKFNNDNNMGG OLJCCAPBLAE)
	{
		return default(bool);
	}
}
