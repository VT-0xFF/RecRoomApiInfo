...
namespace System.Runtime.CompilerServices
{
	...
	internal sealed class NullableAttribute : Attribute
	{
		...
		[Cpp2IlInjected.Address(RVA = "0x81C5A70", Offset = "0x81C4270", VA = "0x1881C5A70")]
...
namespace RecRoom.Cameras.Effects
{
	...
	public class CameraFadeOptions
	{
		...
		[Cpp2IlInjected.Address(RVA = "0x81C59B0", Offset = "0x81C41B0", VA = "0x1881C59B0")]
	...
	public readonly struct CameraFadeParams
	{
		...
		[Cpp2IlInjected.Address(RVA = "0x2E71D50", Offset = "0x2E70550", VA = "0x182E71D50")]
		public CameraFadeParams([Optional] float? fadeToBlackDuration, [Optional] float? fadeToCameraDuration)
		{
		}
	}
	[Cpp2IlInjected.Token(Token = "0x2000007")]
	public interface AIVLSPZEPWL : IDisposable
	{
		...
		RBHAPASARCK ZDLUETOLMYG(Token a, [Optional] CameraFadeParams? b);

		[Cpp2IlInjected.Token(Token = "0x600000C")]
		[Cpp2IlInjected.Address(Slot = "5")]
		Task HZHOBWNTXGR([Optional] CancellationToken a);

		[Cpp2IlInjected.Token(Token = "0x600000D")]
		[Cpp2IlInjected.Address(Slot = "6")]
		IReadOnlyCollection<Token> OOZUHGFTLDV();
	}
	[Cpp2IlInjected.Token(Token = "0x2000008")]
	public interface RBHAPASARCK : IDisposable
	{
		[Cpp2IlInjected.Token(Token = "0x600000F")]
		[Cpp2IlInjected.Address(Slot = "0")]
		Task SMWDDNBCETV([Optional] CancellationToken a);
	}
}
